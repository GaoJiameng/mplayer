...
void *pipe_read(void)     //读信息函数
{
    ...
    while(1)
    {
        ...
        else if(strncmp(buf,"ANS_PERCENT_POSITION", 20)==0) //获取进度信息
        {
            percent_dispose(buf);
        }
...
void show_gtk(void)
{
    w.window = gtk_window_new(GTK_WINDOW_TOPLEVEL);
        ...
        window_background(w.window, 1024, 600, "/home/work/background_picture/1.png");
        ...
        w.table_time = gtk_table_new(2,1,TRUE);
        ...
        w.label_singer = gtk_label_new("歌手：Singer      专辑：Album");
        w.label_shrink_song = gtk_label_new("Song Name");
        w.label_time = gtk_label_new("00:00 / 04:00");
        ...
        //加载一张图片
        loadImagePixbuf(w.back_image,"/home/work/icon/back.png", 60,60);
        loadImagePixbuf(w.next_image,"/home/work/icon/next.png", 60,60);
        loadImagePixbuf(w.pause_image,"/home/work/icon/stop.png", 60,60);
        loadImagePixbuf(w.random_image,"/home/work/icon/circulation.png", 28,28);
        loadImagePixbuf(w.switch_image,"/home/work/icon/switch.png", 30,30);
        loadImagePixbuf(w.volume_plus_image,"/home/work/icon/plus.png", 35,35);
        loadImagePixbuf(w.volume_minus_image,"/home/work/icon/minus.png", 35,35);
        loadImagePixbuf(w.list_image,"/home/work/icon/list.png", 28,28);
        loadImagePixbuf(w.disc_image,"/home/work/song_cover/disc.png", 360,360);
        loadImagePixbuf(w.bg_image,"/home/work/song_cover/Symphony.jpeg", 220,220);
        loadImagePixbuf(w.shrink_above_image,"/home/work/song_cover/shrink_above.png", 50,50);
        loadImagePixbuf(w.shrink_image,"/home/work/song_cover/Symphony.jpeg", 50,50);
        loadImagePixbuf(w.shutdown_image,"/home/work/icon/shutdown.png", 30,30);
        //将图片控件放入table容器中
        ...
        gtk_table_attach_defaults(GTK_TABLE(w.table_bar), w.bar, 0,1,19,22);
        ...
        gtk_table_attach_defaults(GTK_TABLE(w.table_time), w.label_shrink_song, 0,1,0,1);
        gtk_table_attach_defaults(GTK_TABLE(w.table_time), w.label_time, 0,1,1,2);
        ...
        //g_signal_connect(w.list,"leave", G_CALLBACK(add_button), &w);

        //g_signal_connect(w.list,"clicked", G_CALLBACK(deal_button), &w);
